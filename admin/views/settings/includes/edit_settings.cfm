...
<cfoutput>
	<ul class="form">
		...
		<li>
			<label for="ListExcludedSubtypes">Excluded Subtypes</label>
			<input class="text" type="text" name="ListExcludedSubtypes" id="ListExcludedSubtypes" value="#form.ListExcludedSubtypes#" size="150" maxlength="150" data-required="false" />
			<p><small>List of Page Subtypes that should not be used for the News XML file. This list overrides anything noted in the Page Extended Attributes tab.</small></p>
		</li>
		<li>
			<label for="email">
